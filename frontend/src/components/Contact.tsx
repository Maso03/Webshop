      ...
      <main className="container mx-auto p-4 bg-white shadow-md mt-4 w-full lg:w-2/3">
        ...
        <section className="mb-6">
          ...
          <p>
            ...
            entrepreneurs Masoud and Niklas, who wanted to revolutionize the way
            people shop online. Our journey began in a small garage in
          ...
          <p className="mt-4">
            ...
            prices while maintaining exceptional customer service. We believe in
            building lasting relationships with our customers, and our dedicated
            team works tirelessly to ensure that every order is processed with
            care and attention to detail.
          </p>
          <p className="mt-4">
            Join us on our journey as we continue to innovate and bring you the
            best online shopping experience. Thank you for choosing TrendVault
            Webshop!
          </p>
        </section>
      </main>
